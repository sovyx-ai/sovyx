...
Exatamente a sequência que CI executa (reproduz local antes do push):
...
cd dashboard && npx tsc -b tsconfig.app.json && npx vitest run
```
...
- [ ] bandit — zero HIGH.
- [ ] pytest — 100% passando.
- [ ] Coverage ≥ 95% (baseline: 96.05% em v0.1.0).
- [ ] tsc / vitest — 100% passando.
